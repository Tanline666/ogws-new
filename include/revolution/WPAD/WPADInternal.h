...
#endif
    WPADInfo wpInfo;                   // at 0x778 (v0) 0x838 (v1)
    WPADInfo* wpInfoOut;               // at 0x790 (v0) 0x850 (v1)
    WPADDevConfig devConfig;           // at 0x794 (v0) 0x854 (v1)
    WPADExtConfig extConfig;           // at 0x7C2 (v0) 0x882 (v1)
